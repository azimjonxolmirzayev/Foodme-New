...
import userSix from "../assets/logo/logo-01.svg";
    ...
    <>
      ...
      <div className="overflow-hidden rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
          <div className="relative z-30 mx-auto -mt-22 h-30 w-full max-w-30 rounded-full flex items-center bg-white/20 p-1 backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
          ...
          <div className="mt-4">
            ...
            <p className="font-medium">Smal</p>
            ...
            <div className="mx-auto max-w-180">
              ...
              <p className="mt-4.5">
                FoodMe is an online menu service platform for restaurants and
                cafes. It allows users to view restaurant menus online by
                scanning QR codes. Allows restaurant owners to register their
                cafe, add menus and products. Users can quickly and easily view
                their favorite cafe's updated menus and product information via
                QR code. The FoodMe platform implements the backend using
                FastAPI and the frontend using React.
              </p>
            </div>
